            ...
            <span> <!-- actus -->
                ...
                <ul>
                    <li id="article1" class="event">
                        <a href="https://iut.univ-lyon1.fr/campus/bibliotheque/exposition-les-fruits-et-les-legumes-du-monde-entier#.YZjxddDMJQA" aria_label="exposition sur les fruit et légumes du monde entier">
                            <span>
                    ...
                    <li id="article2" class="formation">
                        <a href="https://iut.univ-lyon1.fr/formation/offre-de-formations/informatique-bourg-en-bresse/forum-des-metiers-de-linformatique-a-bourg-en-bresse#.YZjxhtDMJQA" aria_label="forum des métiers de l'informatique, à Bourg-en-Bresse" >
                            <span>
                                <div class="img img-top" alt="affiche du forum des métiers de l'informatique, à bourg en bresse"></div>
                                <article>
                    ...
                    <li id="article3" class="event">
                        <a href="https://iut.univ-lyon1.fr/campus/bibliotheque/concours-decriture-2021-2022-de-liut-lyon-1#.YZjxmdDMJQA" aria_label="concours d'écriture à l'IUT Lyon 1">
                            <span>
                                <div class="img img-top" alt="affiche du coucours d'écriture"></div>
                                <article>
                    ...
                    <li id="article4" class="formation">
                        <a href="https://iut.univ-lyon1.fr/actualites/et-toi-tu-fais-quoi-apres-le-bac#.YZjwFtDMJQA" aria_label="et toi, tu fais quoi après le bac?">
                            <span>
                                <div class="img img-top"></div>
                                <article>
                                    <p class="date"> &nbsp </p> <!--dirty trics?-->
            ...
            <section> <!-- carte; contact; logos...-->
                <div> <!-- Contact-->
                    ...
                    <p>
                        ...
                        <span>Tél. <a href="tel:334 72 69 20 00" aria_label="lien pour appeler directement l'IUT"> +33 (0)4 72 69 20 00</a></span>
                    </p>
                </div>
                <div> <!--dessus map-->
                </div>
                <div> <!-- map -->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d734.7577928071403!2d4.882795097036954!3d45.78614521419196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3029697856ecb11c!2zNDXCsDQ3JzEwLjciTiA0wrA1MycwMS41IkU!5e0!3m2!1sfr!2sfr!4v1637406281762!5m2!1sfr!2sfr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" alt="localisation google map"></iframe>
                </div>
                <div> <!-- Dessous map-->
                </div>
                <div class="logo" alt="en partenariat avec"> <!-- Logos -->

                    ...
                    <section>
                        <details id='Prereki'>
                            ...
                            <article>
                                ...
                                <h3>Spécialités du Bac générale :</h3>
                                <section>
                                    <div>
                                        <ul>
                                            <li>Arts</li>
                                            ...
                                            <li>Humanités litérature et philosophie</li>
                                ...
                                <p>Même si ce tableau vous dit quels sont les spécialités les plus adaptés, nous vous conseillons fortement de faire les spécialités Mathématiques et Numériques et Sciences de l'Informatiques, car en plus d'augmenter vos chances d'être selectionner, vous retrouverez ces matières. Il est donc avantageux d'avoir déjà un bagage en arrivant.</p>
                            </article>
                        </details>
                        <details>
                            ...
                            <section>
                                ...
                                <details>
                                    <summary> Quels sont les horaire de travail? </summary>
                                    <p> Vous pourrez avoir cours entre 8h et 18h avec une pause de 12h a 14h sauf le vendredi de 12h à13h30. La plus part du temps vous n'aurez pas cours le jeudi après-midi. Il n'y a aucun cours à l'IUT le samedi.</p>
                                </details>
                            </section>
                        </details>
                        <details>
                        ...
                        <details>
                            ...
                            <section>
                                <details>
                                    ...
                                    <article>
                                        <p> Le studio est une des cafeterias du crous, la plus proche(en face de l'IUT au niveau de l’arrêt de tramway IUT Feyssine). les cafeterias du crous vous propose un menus étudiant composé d'un sandwich, d'un yaourt et d'un dessert pour le même prix que le menus du restaurant universitaire. vous pouvez également prendre un plat chaud ou plein d'autre choses (ça ressemble a une supérette). nous vous conseillons de manger ailleurs car les prix sont élevés.</p>
                                        <p> L’Archimède est aussi une cafèt du crous,en face de l’arrêt de tram INSA EINSTEIN, mais vous permet d'avoir, avec le menu étudiant, des sandwich de meilleur qualité qu'au studio.</p>
